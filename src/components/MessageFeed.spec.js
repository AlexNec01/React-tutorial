...
describe("MessageFeed", () => {
  ...
  describe("Interactions", () => {
    ...
    // it("displays modal when clicking delete on message", async () => {
    //   apiCalls.loadMessages = jest
    //     .fn()
    //     .mockResolvedValue(mockSuccessGetMessagesFirstOfMultiPage);
    //   apiCalls.loadNewMessagesCount = jest
    ...
    //     `Are you sure to delete 'This is the latest message'?`
    //   );
    //   expect(message).toBeInTheDocument();
    // });
    ...
    // it("hides modal after successful deleteMessage api call", async () => {
    //   apiCalls.loadMessages = jest
    //     .fn()
    //     .mockResolvedValue(mockSuccessGetMessagesFirstOfMultiPage);
    //   apiCalls.loadNewMessagesCount = jest
